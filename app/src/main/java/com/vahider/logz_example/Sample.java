...
//    githubCompare();
  ...
  private void githubCompare() {
    ...
    // region data
    Object[] a = new Object[]{1, "Saeed", true, null};
    ...
    Logz.array(list); // List
    Logz.json(json); // String
    Logz.chart(doubleArray); // double[]
    Logz.table(rows, "getId", "getName", "isRegister"); // List<User>

    Logz.line();

    ////////////////////////////////

    Log.i("LOGZ", "-------------Default log example-----------");

    Log.v("LOGZ", "String: " + "with title");

    Log.v("LOGZ", "Without title");
    Log.d("LOGZ", "" + 12345);
    Log.i("LOGZ", "" + true);
    // Log.w("LOGZ", null); // crashed
    Log.e("LOGZ", "" + mTvHomeLogo);

    Log.d("LOGZ", "************ not fast maybe clear");

    Log.d("LOGZ", "" + list);
    Log.d("LOGZ", json);
    Log.d("LOGZ", "" + doubleArray);
  ...
  private void runExamples() {
    ...
    Logz.array("List is", list2);
    Logz.array(new EditText[]{new EditText(this), new EditText(this), null});
    Logz.array(new String[]{"a", "b", null});
    Logz.array(null);
    Logz.array(new TextView(this));
